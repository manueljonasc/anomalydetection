...
├── src/ │   ├── data_preprocessing.py │   ├── feature_engineering.py │   └── model_training.py │ 
├── data/ │   ├── raw/               ← Original data (or link to source) │   └── processed/         ← Cleaned data │ 
├── models/ │   └── best_model.pkl     ← Saved model artifacts │ 
├── reports/ │   ├── technical_presentation.pdf │   └── business_presentation.pdf 
